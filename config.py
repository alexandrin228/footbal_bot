...
# --- Prediction Ledger (OPȚIONAL) - folosește chiar repo-ul GitHub ca bază de
# date persistentă gratuită, ca să urmărim predicțiile în timp și să calculăm
# performanța reală a modelului. Dacă lipsesc, botul funcționează normal mai
# departe (analiză + alerte Telegram), doar fără jurnal/raport de performanță.
GITHUB_TOKEN = os.environ.get("GITHUB_TOKEN", "")
GITHUB_REPO = os.environ.get("GITHUB_REPO", "")  # format "user/repo", ex. "alexandrin228/footbal_bot"

LEDGER_PATH = "data/predictions.jsonl"
STATE_PATH = "data/bot_state.json"
REPORT_INTERVAL_HOURS = 48  # cât de des trimite botul raportul de performanță
